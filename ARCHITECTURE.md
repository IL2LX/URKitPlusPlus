...
| `src/sdk/templates/VRChat/` | Game-specific VRChat adapters, grouped by managed namespace: `VRCSDKBase` wrappers under `VRChat/VRC/SDKBase/`, core API types under `VRChat/VRC/Core/`. |
